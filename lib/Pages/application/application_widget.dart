...
var bottomTabs = [
  BottomNavigationBarItem(label: "Home", icon: SizedBox(
  ...
  BottomNavigationBarItem(label: "Search", icon: SizedBox(
    width: 15.w,
    height: 15.h,
  ...
  BottomNavigationBarItem(label: "Course", icon: SizedBox(
  ...
  BottomNavigationBarItem(label: "Chat", icon: SizedBox(
  ...
  BottomNavigationBarItem(label: "Profile", icon: SizedBox(
